...
class FormController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = [
            ...
            "Text50"                                         => 'CALLE ' . $request->domicilio . ", " . $request->colonia .", " . $request->delegacion . ", C.P. " . $request->codigopostal . ", " . $request->ciudad,
            "rfc"                                            => $request->rfc,
            ...
            "sucursal"                                       => $lugar == 'PUEBLA' ? 'PUEBLA' : 'CORPORATIVO',
        ...
        if ($lugar == "MORELOS") {
            ...
            $pdf = new Pdf('pdfs/puebla-fusionado.pdf');
        } else {
